...
# ╔═╡ fe649e02-00f3-11ed-37fc-191f09316880
begin
        using PlutoUI,HypertextLiteral,LaTeXStrings,Symbolics,LinearAlgebra,RowEchelon,Latexify
        
       
        PlutoUI.TableOfContents()
end

# ╔═╡ fcf2035e-7ab4-4804-aced-c3ad6395aafb
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ a42ca715-4b62-4cb8-b598-cdda9cbcbe53
md"""
# ch06 sec6.2 线性变换的矩阵

!!! outcomes

    - A  求线性变换$T:R^n \rightarrow R^m$ 对应的矩阵形式
"""

# ╔═╡ 5b1f42dd-97f9-4201-bfd3-a03120a4957c
md"""

!!! props
    矩阵变换是线性变换, 线性变换也是矩阵变换
    假定有$m\times n$ 的矩阵 $A$,$T:R^n \rightarrow R^m$ , 如果 有 $T(v)=Av$,则 $T$ 是线性映射

    

"""

# ╔═╡ 4de6f98a-db9c-4403-8b44-8f3a36fc21ac


# ╔═╡ e2e68f72-db97-4f60-9276-c6fc2467fe84


# ╔═╡ 173019aa-64a2-46f2-a184-97b81b14167f


# ╔═╡ 2db18629-a23e-42f1-a1eb-daa07aeec58d
