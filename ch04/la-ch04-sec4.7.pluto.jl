...
# ╔═╡ a1bd7a92-feb5-11ec-003d-61684ebdde2a
begin
...
# ╔═╡ 83bf873b-bdcb-4e44-96e3-a74f57fcef4e
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ c691bbc6-5874-4e74-9620-2e249fbac124
md"""
# ch04 sec4.7  矩阵转置

!!! outcomes
    - A. 计算矩阵的转置
    - B. 判读一个矩阵是否是对称矩阵, 反对称矩阵,或者两者都不是
    - C. 操作包换矩阵转置的代数表达式
"""

# ╔═╡ bd5ad2eb-260a-426b-8b04-d9ac05a7277f
md"""
!!! definition
    矩阵的转置

    设矩阵为$A , m\times n$, $A$ 的转置表示为$A^{T}, n\times m$, $A^{T}$ 的项$(i,j) 对应 A 的 (j,i)$

"""

# ╔═╡ 8f53ad62-2aa3-400e-9231-44f90882e4f6
md"""
...
# ╔═╡ 8df550e4-af90-4beb-bc76-5d6e1644ee66
begin
	A=[1 2 6 ; 3 5 4]
	latexify(A)
...
# ╔═╡ 8ea9308d-7abd-4b16-8679-c30953939d70
begin
	# 取出行, 然后水平拼接
    r1=A[1,:]
	r2=A[2,:]
...
# ╔═╡ 03230163-be93-4cac-b066-58c65233a303
let
	# julia 自带方法 '
...
# ╔═╡ 9550429a-8449-439a-baa8-2d24f4a211ac
md"""
!!! props
    矩阵转置的性质
...
两个向量的点积等价于一个向量转置与另一个向量的积
"""

# ╔═╡ a653f6cf-ecb0-49c9-b2f2-4ee8677219f1
let
	A=[1 2 3]
	B=[4 5 6]
    dot(A,B)
...
# ╔═╡ 898d42cb-a252-42a3-af35-bae4dc25e5b6
let
	A=[1; 2; 3]
	B=[4; 5; 6]
    A'*B
...
# ╔═╡ c94de1a8-183b-45eb-b869-1ca5a0b019a4
md"""
!!! definition
    对称和反对称矩阵

    对称和反对称矩阵有必须是方阵, $n\times n$ 才能满足条件. 如果 $A^T=A$, $A$ 就是对称矩阵, 如果$A^T=-A$, $A$ 就是反对称矩阵
"""

# ╔═╡ 631b568e-7c6e-48d1-91fc-9c7d75053fa2
md"""
!!! example
...
# ╔═╡ 03e3f7aa-2760-4dc3-817b-ec4b155ad1a5
begin
	E=[2 1 3 ; 1 5 -3 ;3 -3 7]
	latexify(E)
...
# ╔═╡ 4baa3c2c-f16a-4eae-a9ba-d769025a6a3e
begin
	ET=E'
	latexify(ET)
...
# ╔═╡ 2ea8c648-3360-42a9-a38c-cd92cab168e7
ET==E    # 所以 E 为对称矩阵

# ╔═╡ 29919122-a938-4b21-b879-8c08ee47b488
begin
	F=[0 1 3 ; -1 0 2 ; -3 -2  0 ]
	latexify(F)
end

# ╔═╡ bb560202-e2df-4a2e-ba67-86c887ed78f1
begin
	FT=F'
	latexify(FT)
end

# ╔═╡ f6143298-2d2a-4f45-936a-a939538f3b6e
FT==-1(F)   # 所以 F 矩阵为反对称矩阵

# ╔═╡ 02b46b78-48da-46cf-a0d3-b769a7ab13dc
begin
	G=[0 1 3 ; 1 5 -3 ; 1 3  0 ]
	latexify(G)
end

# ╔═╡ 74731eae-a0f7-46fc-a06a-7d2d0b1d1b86
begin
	GT=G'
	latexify(GT)
end

# ╔═╡ 69637a6c-7c2c-4736-8ea1-10316260d1c7
GT==G

# ╔═╡ 97efc967-0315-4147-aa6a-53984255ec34
GT==-(G)

# ╔═╡ f7c0caa7-624f-4fde-b4fb-6c80306efe53
#  G 既不是对称矩阵也不是反对称矩阵

# ╔═╡ 8bbd58e6-5d0d-4b73-9a6e-56a0847863a7
begin
        store=Dict()
