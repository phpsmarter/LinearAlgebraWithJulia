...
# ╔═╡ 992d5d22-fe81-11ec-2aa3-3f63821e367b
begin
...
!!! outcomes
    ...
    - A 乘以初等矩阵执行行操作
    - B 求特定行操作的初等矩阵
    - C 以$R=UA$ 的形式写出矩阵的简化阶梯型, $U$ 是可逆矩阵
    - D 以初等矩阵积的形式改写矩阵
"""

# ╔═╡ 8c8f6ffa-e3cc-417f-b171-f55e8505b5d6
md"""
## 4.6.1 初等矩阵和行操作
...
对于计算机, 矩阵乘法也可以完成行操作的任务, 而且在计算机操作中, 擅长执行矩阵乘法操作. 现在计算机或者手机内的GPU 实际主要也完成的是矩阵乘法操作

所以现在就来了解一下初等矩阵如何执行行操作
"""

# ╔═╡ feacde4f-583d-4a1e-ac30-caf165614201
begin
...
# ╔═╡ dec73650-0083-49f7-886f-c258f2ba305f
md"""
如果和 Identity 矩阵比较, 发现第二行与第三行交换了位置. 
"""

# ╔═╡ 84ac5973-7ff7-4fc1-a468-5bc6997692d7
begin
	I=diagm([1,1,1])
	latexify(I)
end
...
# ╔═╡ 2b762072-5dde-430d-87f3-33579809bded
begin
	m1=[1 1 1; 2 2 2; 3 3 3]
	latexify(m1)
end

# ╔═╡ f41b1275-e0b8-4535-ab94-04439d4ab703
begin
   r23=E23*m1   # 第二行与第三行交换位置
   latexify(r23)
	
end

# ╔═╡ 64e17701-c53e-484f-9927-716f4c43d93d
@bind  kval Slider(1:10;default=1,show_value=true)

# ╔═╡ c77dd5ef-b42c-4b6c-bd37-15c97030114b
begin
	k=kval
	E2K=[1 0 0 ; 0 k 0; 0 0 1]
	latexify(E2K)
end

# ╔═╡ 734f77a8-8dfe-4226-bad2-2fade70bca96
md"""

这是为一行倍乘一个标量的初等矩阵
"""

# ╔═╡ f61d633b-b574-4678-ba3e-99c2298d17c7
latexify(E2K*m1)

# ╔═╡ 7e35d15c-be05-441f-b5bb-ab0d393d6a2b
md"""
倍乘一个数然后加到另一行的行操作由下面的矩阵完成

"""

# ╔═╡ 86bbfbd2-40ce-4d77-9d1c-9eacad910618
begin
	
	ERK=[1 0 0 ; 0 1 0; 0 k 1]
	latexify(ERK)
end

# ╔═╡ a0d3567e-0daa-45c9-bfa7-0ebe11e8e4e6
latexify(ERK*m1)   #第二行倍乘k 然后加至第三行

# ╔═╡ 7d996cfd-7d5b-42fe-8408-dd1bdf0ff7eb
md"""
## 4.6.2 初等矩阵的逆

当我们用初等矩阵对矩阵进行操作时, 要能够复原, 也就是行操作是可逆的. 这个操作由初等矩阵的逆矩阵来完成. 

!!! theorem

    每个初等矩阵都是可逆的, 逆矩阵同样也是初等矩阵

"""

# ╔═╡ 7a9f6b95-6bcd-4243-a794-956bbfd72155
md"""
## 4.6.3 初等矩阵和简化阶梯型矩阵

一个矩阵可以通过多步初等矩阵乘法简化为阶梯矩阵. 简化阶梯型遵循下面的定理

!!! theorem

    假设 矩阵$A$ 为任意 $m \times n$ 矩阵, $R$ 为其简化阶梯形式. 则存在一个可逆的$m\times m$ 的矩阵, 称为$U$. 三者有如下关系:

    $R=UA$

    $U$ 可以看做是从矩阵到简化阶梯型行变换矩阵的乘积形式(方向为从右至左)



"""

# ╔═╡ cee8c8fb-244a-4439-b324-be2f9e5e1147
md"""
...
# ╔═╡ c94d5963-31a4-4a56-b121-736d0ef4b4b5
begin
	G=[0 1; 1 0 ; 2 0]
	latexify(G)
end

# ╔═╡ 6564fe3d-1b4e-41a0-9baf-0658b941ddec
md"""
1. 首先要确定一列的主元, 交换第一行和第二行

   使用下面的初等矩阵
"""

# ╔═╡ 45a0eeff-e837-49c9-ad9d-c9f7aa714b49
begin

	E21=[0 1 0 ;  1 0 0 ; 0 0 1]
	latexify(E21)
end

# ╔═╡ f2cbeb40-69c1-4051-85a7-2c590ff80948
begin
	G1=E21*G
	latexify(G1)
...
# ╔═╡ 6afbae05-2a49-4fa2-b4e9-0c335be11596
md"""
  现在第一行和第二行都有主元, 对第三行进行操作
2. 第三行减去二倍的第一行
"""

# ╔═╡ 12ef2143-0424-4de2-9016-26f4bf6e2209
begin
	E31=[1 0 0; 0 1 0 ; -2  0 1]
	latexify(E31)
end

# ╔═╡ f54a82e6-25f7-4509-8daa-8db0c9f6428e
begin
	G2=E31*G1
	latexify(G2)
end

# ╔═╡ a6a017c8-9eb2-41ec-94bd-60b55fac69c4
md"""
  现在矩阵就是简化阶梯型
  所有$U$ 由  E21,E31 从右至左相乘而形成得到
  $U=E31E21$
"""

# ╔═╡ 697faf2f-4b15-4eb2-b41f-42149862eb2d
begin
...
# ╔═╡ 5ff5fcf2-2aba-435f-adc6-0b52238f39e7
begin
	R=U*G    # 简化阶梯型
	latexify(R)
end

# ╔═╡ 6e20ddb4-ee65-4b9d-9ea3-3bc95926d937
md"""

!!! theorem

    在实际操作中, 如果 $A$ 矩阵可逆, 对增广矩阵$[A|I]$,进行行化简操作就可以得到$[R|U]$
"""

# ╔═╡ 24b48595-b768-460e-b395-4f08d6cb9002
begin
...
# ╔═╡ 29826818-e20c-40cc-89ef-0fd214bb64a4
begin
...
# ╔═╡ 92c75692-e5fa-4bae-8866-d2541b8b432f
begin
	r21=augmatrix1[1,:]
	r22=augmatrix1[2,:]
	r33=augmatrix1[3,:]
	r33=r33-2*r21
	augmatrix2=[r21';r22';r33']
	latexify(augmatrix2)
	
end

# ╔═╡ e44e1c25-9a3e-4861-ab8f-00da1bb0cf64
begin
...
# ╔═╡ 9292c347-b1c0-4302-a2b7-2ce5d0b2ccf3
begin
	U1=augmatrix2[:,3:5]
	latexify(U1)
end
