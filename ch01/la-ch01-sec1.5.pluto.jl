...
# ╔═╡ 147b2b26-f9e1-11ec-0639-11b0d76445d7
begin
...
# ╔═╡ d8cba45c-1876-4cc3-bb64-bd21df21d754
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ 7b862be8-8dba-4fd6-9c3f-4b25b105f8fd
md"# ch01 sec1.5 Gauss-Jordan 消元法

!!! outcomes
    - A. 求矩阵的简化阶梯型
    - B. 用Gauss-Jordan 消元法解线性方程组
"

# ╔═╡ 8826bd31-fcc2-47e6-8b99-22c1f3699d02
md"""
Gauss-Jordan 消元与 Gauss消元方法相同, 不同之处在于, Gauss-Jordan 消元得到的阶梯型矩阵的主元系数都为 1, 这样做在回带时操作更加便捷
...
阶梯型矩阵称为简化阶梯型, Gauss-Jordan 消元法最终想获取的矩阵形式就是简化阶梯型
"""

# ╔═╡ d1b164f9-9b52-427e-9662-545c2cb44296
md"""
!!! algorithm
    Gauss-Jordan 消元法 步骤

    1. 首先是会用高斯消元法简化矩阵为阶梯型矩阵
    2. 从右至左, 用行变换把所有主元列上除了主元位置的元素都变换为$0$
    3. 矩阵每行元素除以所在行主元的系数,使得主元的系数为$1$

"""

# ╔═╡ 24900b72-7c79-48f9-b0f6-ae52aceaf527
md"""
...
在上一小节, 我们以及获得了方程组的阶梯型矩阵
    
"""

# ╔═╡ f0e84f9d-b1b1-4fb1-89d9-80114e0d24f8
md"1. 接着执行Gauss-Jordan 消元, 第二行减去第三行, 第一行减去 3 倍的第三行:"

# ╔═╡ 04389b56-f826-4ae1-8455-b85ccf4a73f2
md"2. 第一行减去 2 倍的第二行"

# ╔═╡ 88601928-3120-4d9f-8bb8-2c625a39ee6c
md"3. 第二行元素都除以主元的系数$2$"

# ╔═╡ d4f5e563-3712-4c3a-82c3-14914a2f33bc
md"""
现在常数矩阵的一列就是方程组的解, 这是因为系数矩阵的简化阶梯型已经更为特殊, 是一个对角为$1$, 其他位置都为$0$ 的矩阵. 
"""

# ╔═╡ 31387e84-f84e-4573-a6d1-69e04cec3214
md"""
增广矩阵的系数矩阵可以是多列, 这样可以同时解多个线性方程组
...
# ╔═╡ 1a01f6b4-3cff-47ec-8a62-1f9267dc81d9
md"第二行减去 2 倍第一行, 第三行减去 3 倍第一行"

# ╔═╡ 99b979dc-6433-41a9-ac61-a810b0b0e5e1
md"第三行减去2 倍第二行:"

# ╔═╡ 4bee2aca-2fbf-44b5-9980-f91b3c380419
md"""
第一个方程组出现了$[0 0 0 | 1]$ 的行, 所以无解. 第二方程组有两个主元$x,y$,$z$ 是自由变量
方程组的解为:

$z=t,x=2-t, y=1-t$
"""

# ╔═╡ 0e2e6ec6-a672-4a1b-8490-bb8e3298fe99
begin
        store=Dict()
...
# ╔═╡ 0c6fc2b0-4b97-405a-b745-c946afd6178a
store["rowchange4"]

# ╔═╡ 58981e0b-ce15-4343-9ec4-7411a1591769
store["rowchange5"]

# ╔═╡ bd78d017-dc54-4457-a3f7-29ea599cc836
store["rowchange6"]

# ╔═╡ 855f03c2-e6c2-41c8-a585-5d163361a294
store["rowchange7"]

# ╔═╡ cd249d70-6d0c-4956-af42-3c3900cd2104
let
	@variables x,y,z
	r1=[1 4 3 11]
	r2=[2 10 7 27]
...
# ╔═╡ 67554760-3ffe-43fd-a925-e555cccf0172
store["augmentmatrix2"]

# ╔═╡ 59cdba31-45fb-4f7f-94e8-4a8ed7be4980
store["rowchange21"]

# ╔═╡ 65747937-13bb-44b1-96c2-013647bfae9a
store["rowchange22"]

# ╔═╡ 11843a45-e1aa-4800-b45d-7745d161fd26
let
	r1=[1 0 1 1 2]
	r2=[2 1 3 2 5 ]
	r3=[3 2 5 4 8]
	augmentmatrix=[r1;r2;r3]
	save("augmentmatrix2",augmentmatrix)
