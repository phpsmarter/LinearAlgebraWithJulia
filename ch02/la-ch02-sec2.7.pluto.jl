...
# ╔═╡ 0668fc22-fcf0-11ec-27af-635deba2f5c5
begin
...
# ╔═╡ d3e108d3-d16a-4d4e-94a0-57f9d657d367
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ 926a4e5f-57e4-4499-ab7b-6941efaf757d
md"""
# ch02 sec2.7 叉积(cross product)
...
叉积只在三维空间下定义, 两个向量的点积映射为一个实数, 两个向量的叉积映射为一个新的向量

"""

# ╔═╡ 0ad34824-4419-4471-a017-fc3458fc337c
md"""
...
右手法则定义了三个向量的方向关系.  伸出右手, 	食指代表向量$v$, 中指代表向量$w$, 则拇指指向向量$u$

![](https://tva1.sinaimg.cn/orj360/e6c9d24egy1h3x6kjy6e1j20h00f6gm2.jpg)
"""

# ╔═╡ 8922bb4d-f746-446b-8485-d20b7dc5f4b7
md"""
## 叉积的几何描述
...
!!! definition
    ...
    叉积的几何定义:
    给定两个向量  给定$R^n$ 中两个向量u:$\begin{bmatrix} u_1\\u_2 \\u_3 \end{bmatrix}$ 和 $v:\begin{bmatrix} v_1\\ v_2 \\v_3 \end{bmatrix}$.  叉积写为$u\times v$

    1. 长度为: $||u\times v||=||u|| \ ||v|| sin\theta$,$\theta 为 u,v 的夹角$
    2. 正交于$u,v$
    3. 右手法则严格按照 $u\times v$ 顺序
...
# ╔═╡ fdf8b313-3ef6-4878-8bfc-7c2e1c61cf72
begin
		function vec_plot3d(v1,v2,ls=:solid)
			v11,v12,v13=v1[1],v1[2],v1[3]
			v21,v22,v23=v2[1],v2[2],v2[3]
			return plot([v11,v21],[v12,v22],[v13,v23],label=false, lw=4,ls=ls)
		end
...
# ╔═╡ 18c924c8-7dda-4493-8c0b-a079676c02f0
let
	plotly()
	zero,u,v=[0,0,0],[4,0,1],[2,1,2]
	w=cross(u,v)

	p1=vec_plot3d(zero,u,:dash)
	p2=vec_plot3d!(zero,v,:dash)
	p3=vec_plot3d!(zero,w)
