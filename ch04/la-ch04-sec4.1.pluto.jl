...
# ╔═╡ 9320aa14-fd9c-11ec-3004-45815c0f8228
begin
...
# ╔═╡ b658ca9f-8377-4d6b-b294-b39602a84e1e
PlutoUI.Resource("https://tva1.sinaimg.cn/thumbnail/e6c9d24egy1h2alsw1tzxj20m80gomxn.jpg")


# ╔═╡ 9104b737-da4a-4fa4-9e63-e36a4e98790e
md"""
# ch04 sec4.1  矩阵定义和相等的定义
...
我们在第一章已经使用增广矩阵的形式来表示线性方程组. 

随着理论的发展, 矩阵的不仅仅用于解线性方程组, 还能够解决更多的问题.  

从矩阵的形式来看, 它是组织数据的一种形式, 在一般形式下, 矩阵有一般性的性质和特殊的性质. 了解矩阵的这些性质才能更好的使用矩阵. 


"""

# ╔═╡ edf5067e-f89d-4871-8f9b-c5ccdeef84d7
md"""
矩阵的组织形式以行和列的形式实现. 矩阵中每单个数据用行列的索引来表示

所以可以用$matrix[i,j]$ 的形式从矩阵中调用数据

方法上有差别, 得到的矩阵没有区别

"""

# ╔═╡ b94457bd-ff2a-4b14-adbb-7603359a99c1
md"""
...
# ╔═╡ 6729b0d4-4be6-46fb-87f0-4e62c75cfe2c
row=[1 2 3 4]   # julia 定义行向量的方法, 没有分隔符, 用空格表示, 得到的实际是一个 $1x4 矩阵$

# ╔═╡ e4163b60-854c-47da-b74c-de3ad8eec0ce
begin
	# 定义一个三行四列的矩阵
	r1=[1 2 3 4]   # 定义
	r2=[5  2  8  7]
...
# ╔═╡ f8caad77-fb05-46cd-8ba5-9b14f83a921e
matrix34[:,1]  # 第一列, :表示第一列中的每一行

# ╔═╡ 08e83b75-8f52-41d6-92c5-528dc532041d
matrix34[:,2]  # 第二列

# ╔═╡ 59c93905-4ac8-457d-a9ea-a4960901fb8f
matrix34[1,:] # 第一行, :表示第行中所有列

# ╔═╡ b86a5d95-dc20-4242-8087-5cbac06528a8
matrix34[1,1]  

# ╔═╡ 6c6b86e4-12b2-41b6-a3ee-5d2d02f92a79
matrix34[3,4]

# ╔═╡ a0534c03-5562-45a8-a7dc-ce1df527173e
matrix34[1,:]'  # ' 表示转置, 这是一个向量

# ╔═╡ 3b832812-a57f-4e19-8c55-e70ba13af3e8
r1          # 这里实际定义的是只有一行的矩阵

# ╔═╡ 8e0bb007-fb0b-46ae-b2a8-37c256e2296b
md"""
当我们需要动态的生成矩阵的时候, julia 有`cat`, `vcat`,`hcat`,`hvcat`
...
# ╔═╡ 33d0e2de-c570-47cc-bcdd-7841cdf31b60
let
	a = [1, 2, 3, 4]
    b = [5, 10, 15, 20]
    cat(a, b, dims =(2, 2))
...
# ╔═╡ 8da191f8-aa8e-4905-8362-da06bb5b7526
let
	a = [5 10 15 20]
	b = [2 4 6 8; 1 3 5 7]
	vcat(a, b)
...
# ╔═╡ f9b30b72-7160-402f-aad3-2f966322d4e1
let
	a = [5; 10; 15; 20; 25]
...
# ╔═╡ a9e002b4-8afb-4902-be89-21a7815234cc
let
	a, b, c, d = 5, 10, 15, 20
	[a b; c d]
	hvcat((2, 2), a, b, c, d)
...
# ╔═╡ d15f9a86-9b09-408f-9336-f5502d818f92
md"""
## 判断矩阵是否相等

判断矩阵是否相等, 首先矩阵的行数和列数要相等, 如果行列数不等, 就不用在继续比较了
