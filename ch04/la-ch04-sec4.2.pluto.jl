...
# ╔═╡ 14490616-fdc0-11ec-1dd5-3f87f0934c57
begin
...
!!! definition
    ...
    假设$A=[a_{ij}],B=[b_{ij}]$, 都是$m 行, n 列的$ 矩阵, 那么 $C=A+B$ 也是$m 行, n 列$ 矩阵, $C=[c_{ij}]$,其中:

    $c_{ij}=a_{ij}+b_{ij}$

"""

# ╔═╡ 52872662-b903-4874-9d9d-4cd3c1875f63
A=[1 2 3;
     1 0 4
  ]

# ╔═╡ 050810a6-3bcf-437d-9a98-67231f2d11d8
B=[5 2 3;
   -6 2 1
]

# ╔═╡ 16acb944-b5df-4965-aaf8-267cb9f8ad66
A+B   #对位相加

# ╔═╡ 5b5937e1-bd4d-4449-8f7f-82a87af20212
C=[1 3;
   4 5
]

# ╔═╡ fe52b80b-ea9f-4b28-a373-ce7bcbf7fdb5
#  A+C    会报出错误, 维度不匹配

# ╔═╡ 95c16910-3b3f-468e-a061-09082dfe6e54
md"""
## zero 矩阵

可以用 julia 方法 `zero` 生成
...
# ╔═╡ df2f1783-c3ef-4e9a-8617-481c1fb447d1
 zeros(Int8,2, 3)

# ╔═╡ bae1836e-78ca-4075-81ff-788555750664
md"""
...
# ╔═╡ 8d653129-fa14-47eb-876f-5135ccfdbf50
A-B

# ╔═╡ de9a7a45-0d42-4c0b-9b07-72c0f96e3167
md"""
